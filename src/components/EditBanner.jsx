...
const EditBanner = () => {
  ...
  const handleUpdate = (e) => {
    ...
    axios
      .post(
        `https://travel-journal-api-bootcamp.do.dibimbing.id/api/v1/update-banner/${param.id}`,
        valueBanner,
        {
          headers: {
            apiKey: "24405e01-fbc1-45a5-9f5a-be13afcd757c",
          ...
          <CardHeader className="text-3xl font-bold">
            <CardContent>
              ...
              <Input
                ...
                onChange={(e) =>
                  setValueBanner({ ...valueBanner, name: e.target.value })
                }
                placeholder="Banner Name"
                defaultValue={valueBanner.name}
              />
              ...
              <Input
                ...
                defaultValue={valueBanner.imageUrl}
              />
